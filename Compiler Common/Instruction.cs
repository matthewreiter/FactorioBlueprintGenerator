...
namespace CompilerCommon
{
    public class Instruction
    {
        ...
        {
            return Enumerable.Repeat(new Instruction { OpCode = Operation.NoOp }, cycles);
        }
        ...
        public static Instruction Pop(int outputRegister, int additionalStackPointerAdjustment = 0)
        {
            return new Instruction
            {
        ...
        {
            return Push(immediateValue: value);
        }

        public static Instruction PushRegister(int inputRegister)
        {
            return Push(inputRegister: inputRegister);
        }

        public static Instruction Push(int inputRegister = 0, int immediateValue = 0)
        {
            return new Instruction
            {
        ...
        public static Instruction AdjustStackPointer(int offset)
        {
            return new Instruction
            {
        ...
        public static Instruction ReadStackValue(int offset, int outputRegister)
        {
            return ReadMemory(outputRegister, SpecialRegisters.StackPointer, offset);
        }

        public static Instruction WriteStackValue(int offset, int inputRegister = 0, int immediateValue = 0)
        {
            return WriteMemory(SpecialRegisters.StackPointer, offset, inputRegister, immediateValue);
        }

        public static Instruction ReadMemory(int outputRegister, int addressRegister = 0, int addressValue = 0)
        {
            return ReadSignal(outputRegister, addressRegister, addressValue, signalValue: 1);
        }

        public static Instruction WriteMemory(int addressRegister = 0, int addressValue = 0, int inputRegister = 0, int immediateValue = 0)
        {
            return new Instruction
            {
                OpCode = Operation.Write,
        ...
        public static Instruction ReadSignal(int outputRegister, int addressRegister = 0, int addressValue = 0, int signalRegister = 0, int signalValue = 0)
        {
            return new Instruction
            {
                OpCode = Operation.Read,
        ...
        public static Instruction BinaryOperation(Operation opCode, int outputRegister, int leftInputRegister = 0, int leftImmediateValue = 0, int rightInputRegister = 0, int rightImmediateValue = 0)
        {
            return new Instruction
            {
                OpCode = opCode,
