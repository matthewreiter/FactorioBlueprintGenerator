...
public static class MusicBoxSignals
{
    ...
    [
        ...
        [
            VirtualSignalNames.LetterOrDigit('A'),
            VirtualSignalNames.LetterOrDigit('B'),
            VirtualSignalNames.LetterOrDigit('C'),
            VirtualSignalNames.LetterOrDigit('D'),
        ],
        [
            VirtualSignalNames.LetterOrDigit('E'),
            VirtualSignalNames.LetterOrDigit('F'),
        ],
        [
